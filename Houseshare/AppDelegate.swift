...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool
    {
        ...
        //This is for the google sign in, Id is found in the plist
        GIDSignIn.sharedInstance().clientID = "357610137059-8vi00u794vcqb5u5ue2ei03j5v7fmb0j.apps.googleusercontent.com"
        GIDSignIn.sharedInstance().delegate = self
        
        return true
    }
    
    //If a user comes from another app using google sign in
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Houseshare")
